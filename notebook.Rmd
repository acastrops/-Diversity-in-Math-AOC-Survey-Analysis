...
#probit
#summary(update(anxiety_model, method = "probit", Hess = TRUE), digits = 3)
...
# head(predict(anxiety_model, data, type = "p"))
 #addterm(anxiety_level, ~.^2, test = "Chisq")   ## not working
 

#Model selection
#anxiety_model_2 <- stepAIC(anxiety_model, ~.^2)
#anxiety_model_2


#Anova
#anxiety_model_2$anova
#anova(anxiety_model, anxiety_model_2)

#Plot
anxiety_model_3 <- update(anxiety_model, Hess=TRUE)
pr <- profile(anxiety_model_3)
confint(pr)
plot(pr)
pairs(pr)
