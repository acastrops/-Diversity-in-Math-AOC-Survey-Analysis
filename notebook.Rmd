...
An assumption of the chi-squared test is that each cell in the crosstab has an expected value of at least 5. Since we can see frequencies below that, we should double check that 
