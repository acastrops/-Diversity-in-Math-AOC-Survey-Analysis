...
In both male and not-male respondents, the majority of students have at one point considered an AOC in Math.
...
Similar results are seen when we break down by ethnicity, where in all cases over 50\% of the respondents have considered an AOC in math.
